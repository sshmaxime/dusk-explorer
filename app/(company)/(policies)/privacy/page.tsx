...
export default function PrivacyPolicy() {
  return (
    <Page title="Privacy Policy" subtitle="Read carefully." separator>
      {`Dusk Explorer Privacy Policy

PLEASE READ THE PRIVACY POLICY CAREFULLY.

Dusk Explorer (referred to as the “Company,” “Dusk Explorer,” “we,” “our,” or “us”) is committed to the protection of your Personal Data and takes the matter of protecting your privacy as a high priority.
...
This Privacy Policy covers the information we collect about you when you use our products or services, or otherwise interact with Dusk Explorer, unless a different privacy policy is displayed. This policy also explains your choices about how we use information about you.
...
As cookies allow you to take advantage of some of the Website’s essential features, we recommend that you accept cookies. For instance, if you block or otherwise reject our cookies, you will not be able to use any products or services on the website that may require you to log in (token holdings store cookies for favorites).
...
We also use a third-party service provider(s) to assist us in better understanding the use of our site. Our service provider(s) will place cookies on the hard drive of your computer and will receive information that we select, for example, how visitors navigate around our site, what pages are browsed, and general transaction information. Our service provider(s) analyzes this information and provides us with aggregate reports.
...
The following is how we store the web server site visit logs (applicable to https://duskexplorer.com):

(i) To throttle the rate of requests and prevent certain types of attacks against us, we track the incoming IP addresses for very short periods of time and are then released.
...
(d) for business development purposes such as statistical and marketing analysis, systems testing, maintenance and development, customer surveys, or to help us in any future dealings with you, for example, by identifying your requirements and preferences;
(e) to comply with any legal or regulatory requirements; and/or
(f) for all other purposes ancillary to any of the purposes stated above. ("Core Purposes")
...
You may request to obtain information on your personal data and also update or make amendments to your personal data as below: (a) for online registered customers, you may log in to your online account and update your personal data.

Please note that depending on the information requested, a nominal fee may be charged and/or backed by the Ethereum signed message. We will endeavor to provide the information back to you as soon as practicable. However, we also reserve the right to validate all requests for the authenticity of the request.

6. WITHDRAWING CONSENT

Please note that it is obligatory for the Company to process your Personal Data for the Core Purpose as stated above, without which some services or features provided by Dusk Explorer may be affected.
...
The Company stores data in a global hosting provider with servers across regions, and we shall take all reasonable steps to ensure that all Personal Data is destroyed or permanently deleted when no longer required for the Purpose and prepare a disposal schedule for inactive data after a 24-month period.
...
Please note that this Privacy Statement may be amended from time to time in accordance with applicable laws and regulations, and such variations may be applicable to you.

For further inquiries or complaints in relation to our handling of your Personal Data or our Privacy Policy or wish to access, update, or amend your Personal Data as mentioned above, please contact us via our feedback form at Contact Us.
`}
    </Page>
  );
}
